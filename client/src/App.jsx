...
function App(){
  ...
  const BonTransportView = () => {
    ...
    const [form, setForm] = useState({
      ...
      service:       activeUser?.name ? activeUser.name.split(" ")[0] : "",
      site:          "",
    ...
    const removeArticle = i => {
      ...
      const arts = form.articles.filter((_,idx)=>idx!==i);
      setForm({...form, articles:arts});
    };

    // Imprimer via window.print()
    const printBT = () => {
      const logoB64 = settings.logo || "";
      const articlesRows = form.articles.map(a=>`
        <tr>
          <td style="padding:9px 10px;border:1px solid #E8ECF1;font-weight:700;color:#00875A">${a.ref||""}</td>
          <td style="padding:9px 10px;border:1px solid #E8ECF1;color:#0D1B2A">${a.designation||""}</td>
          <td style="padding:9px 10px;border:1px solid #E8ECF1;text-align:center;font-weight:700;color:#0D1B2A">${a.qte||""}</td>
        </tr>`).join("");

      const logoHtml = logoB64
        ? `<img src="${logoB64.startsWith("data:") ? logoB64 : "data:image/png;base64,"+logoB64}" style="height:65px;width:auto;object-fit:contain"/>`
        : `<div style="font-size:22px;font-weight:800;color:#00875A">M.R.D.P.S 27</div>`;
...
<style>
  *{box-sizing:border-box;margin:0;padding:0;font-family:Arial,sans-serif;font-size:12px;color:#0D1B2A}
  ...
  .header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:18px;padding-bottom:14px;border-bottom:3px solid #00875A}
  .logo-block{display:flex;align-items:center;gap:14px}
  .bl-num{text-align:right}
  .bl-num-label{font-size:9px;color:#888;text-transform:uppercase;letter-spacing:1px}
  .bl-num-val{font-size:20px;font-weight:800;color:#0D1B2A}
  .section-title{font-size:9px;font-weight:700;color:#00875A;text-transform:uppercase;letter-spacing:1.5px;margin:14px 0 8px;border-bottom:1px solid #E8ECF1;padding-bottom:4px}
  ...
  .field-label{font-size:9px;color:#8B9BB4;text-transform:uppercase;letter-spacing:.8px;margin-bottom:3px}
  .field-val{font-size:12px;font-weight:500;color:#0D1B2A;border-bottom:1px solid #E8ECF1;padding:4px 0;min-height:22px}
  ...
  .check{width:14px;height:14px;border:2px solid #CBD5E0;border-radius:3px;display:inline-block;vertical-align:middle;margin-right:5px}
  .check.yes{border-color:#00875A;background:#E3FCEF;position:relative}
  .check.yes::after{content:"✓";position:absolute;top:-2px;left:1px;font-size:11px;color:#006644;font-weight:700}
  ...
  .autres-box{min-height:44px;border:1px solid #E8ECF1;border-radius:6px;padding:9px 12px;color:#4A5568;background:#FAFBFC;margin-bottom:12px;line-height:1.6}
  .footer-row{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:14px;padding-top:12px;border-top:1px solid #E8ECF1}
  .sign-zone{border:1px dashed #CBD5E0;border-radius:6px;height:52px}
  .footer-doc{margin-top:18px;padding-top:12px;border-top:2px solid #00875A;text-align:center;font-size:9px;color:#888;line-height:1.8}
...
<div class="header">
  <div class="logo-block">
    ${logoHtml}
    <div>
      <div style="font-size:15px;font-weight:800;color:#00875A">M.R.D.P.S 27</div>
      <div style="font-size:9px;color:#888;letter-spacing:1px;text-transform:uppercase;margin-top:2px">Bon de transport</div>
    </div>
  </div>
  <div class="bl-num">
    <div class="bl-num-label">N° Bon de transport</div>
    <div class="bl-num-val">${form.numeroBT}</div>
...
<div class="grid2">
  <div class="box">
    <div style="font-size:9px;font-weight:700;color:#00875A;text-transform:uppercase;letter-spacing:1px;margin-bottom:8px">Expéditeur</div>
    <div style="font-weight:700">M.R.D.P.S 27</div>
    <div style="color:#4A5568;margin-top:3px">5 Rue du Fond du Val</div>
    <div style="color:#4A5568">27600 Saint-Pierre-la-Garenne</div>
    <div style="color:#4A5568;margin-top:3px">Tél : 02 32 21 09 23</div>
    <div style="color:#4A5568">Mobile : 06 47 61 18 28</div>
  </div>
  <div class="box-green">
    ...
    <div style="color:#4A5568;margin-top:4px">${form.livAdresse}</div>
  </div>
</div>

<div class="section-title">Informations d'expédition</div>
<div class="grid3">
  <div><div class="field-label">Service</div><div class="field-val">${form.service}</div></div>
  <div><div class="field-label">Site</div><div class="field-val">${form.site}</div></div>
  <div><div class="field-label">Interlocuteur</div><div class="field-val">${form.interlocuteur}</div></div>
</div>

<div class="express-row">
  <span style="font-weight:700">Express :</span>
  <span><span class="check ${form.express?"yes":""}"></span> OUI</span>
  <span><span class="check ${form.express?"":"yes"}"></span> NON</span>
</div>
...
<div class="autres-box">${form.autreInfo}</div>

<div class="footer-row">
  <div><div class="field-label">Date</div><div class="field-val">${form.date}</div></div>
  <div><div class="field-label">Signature</div><div class="sign-zone"></div></div>
</div>

<div class="footer-doc">
  <div style="font-weight:700;color:#00875A;font-size:10px;margin-bottom:4px">M.R.D.P.S 27</div>
  <div>5 Rue du Fond du Val — 27600 Saint-Pierre-la-Garenne — RCS Évreux 850 373 994</div>
  <div>Tél : 02 32 21 09 23 | Mobile : 06 47 61 18 28 | comptabilite@mrdps27.fr</div>
  <div>T.V.A. Intracom N° FR 72850373994 | www.mrdps27.fr</div>
  <div style="margin-top:4px;color:#bbb">${form.numeroBT} — Généré par MRDPSTOCK v3</div>
</div>
</body></html>`;
    ...
    const inputStyle = {
      ...
      border:`1.5px solid ${T.bdr}`, background:T.white,
      color:T.txt, fontSize:13, fontFamily:"inherit", outline:"none",
      ...
      <div className="anim">
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20,flexWrap:"wrap",gap:12}}>
          <div>
            ...
            <div style={{fontSize:12,color:T.muted,marginTop:2}}>Tous les champs sont modifiables avant impression</div>
          </div>
          <div style={{display:"flex",gap:8}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:16}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:14}}>
            ...
            <Card>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                <div>
                  <label style={labelStyle}>N° Bon de transport</label>
                  <input style={{...inputStyle,fontWeight:700,color:T.brand}} value={form.numeroBT} onChange={e=>setForm({...form,numeroBT:e.target.value})}/>
                </div>
                <div>
            ...
            {/* Infos expédition */}
            <Card>
              <div style={{fontWeight:600,fontSize:13,color:T.txt,marginBottom:14}}>Informations d'expédition</div>
              <div style={{display:"flex",flexDirection:"column",gap:12}}>
                <div>
                  <label style={labelStyle}>Service</label>
                  <input style={inputStyle} value={form.service} onChange={e=>setForm({...form,service:e.target.value})} placeholder="Ex: Informatique"/>
                </div>
                <div>
                  <label style={labelStyle}>Site</label>
                  <input style={inputStyle} value={form.site} onChange={e=>setForm({...form,site:e.target.value})} placeholder="Ex: Entrepôt Nord"/>
                </div>
                <div>
                  <label style={labelStyle}>Interlocuteur</label>
                  <input style={inputStyle} value={form.interlocuteur} onChange={e=>setForm({...form,interlocuteur:e.target.value})} placeholder="Nom de l'interlocuteur"/>
                </div>
              </div>
            </Card>
                ...
                <div style={{display:"flex",gap:12}}>
                  {[{v:true,l:"OUI"},{v:false,l:"NON"}].map(opt=>(
                    <div key={String(opt.v)} onClick={()=>setForm({...form,express:opt.v})}
                      style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",padding:"6px 14px",borderRadius:8,
            ...
            {/* Point de livraison */}
            <Card>
              <div style={{fontWeight:600,fontSize:13,color:T.txt,marginBottom:14}}>Point de livraison</div>
              <div style={{display:"flex",flexDirection:"column",gap:10}}>
                <div>
                  <label style={labelStyle}>Nom / Base client</label>
                  <div style={{display:"flex",gap:8}}>
                    <input style={{...inputStyle,flex:1}} value={form.livNom} onChange={e=>setForm({...form,livNom:e.target.value})} placeholder="Nom du destinataire"/>
                    <Sel value="" onChange={e=>{if(e.target.value){const c=state.clients[e.target.value];setForm({...form,livNom:c.name});}}} style={{flexShrink:0,width:120}}>
                ...
                <div>
                  ...
                  <textarea value={form.livAdresse} onChange={e=>setForm({...form,livAdresse:e.target.value})}
                    ...
                    style={{...inputStyle,height:64,resize:"vertical",lineHeight:1.5}}/>
                </div>
              </div>
            </Card>
          </div>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:14}}>
            ...
            <Card p={0} sx={{overflow:"hidden"}}>
              <div style={{padding:"14px 16px",borderBottom:`1px solid ${T.bdr}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                <div style={{fontWeight:600,fontSize:13,color:T.txt}}>Références / Articles</div>
                <Btn size="sm" onClick={addArticle}><Ic n="plus" s={12}/>Ajouter</Btn>
              </div>
              <div style={{padding:12,display:"flex",flexDirection:"column",gap:8}}>
                {form.articles.map((a,i)=>(
                  <div key={i} style={{display:"grid",gridTemplateColumns:"110px 1fr 64px 28px",gap:6,alignItems:"center"}}>
                    <input style={{...inputStyle,padding:"6px 8px",fontSize:12,fontWeight:700,color:T.brand}} value={a.ref} onChange={e=>updateArticle(i,"ref",e.target.value)} placeholder="Référence"/>
                    <input style={{...inputStyle,padding:"6px 8px",fontSize:12}} value={a.designation} onChange={e=>updateArticle(i,"designation",e.target.value)} placeholder="Désignation"/>
                    <input type="number" min="0" style={{...inputStyle,padding:"6px 8px",fontSize:12,textAlign:"center"}} value={a.qte} onChange={e=>updateArticle(i,"qte",e.target.value)} placeholder="Qté"/>
              ...
              <div style={{padding:"8px 12px",borderTop:`1px solid ${T.bdr}`,background:"#F8FAFC"}}>
                <Btn v="secondary" size="sm" onClick={()=>{
                  const sItems=(state.clients[state.activeClient]?.items||[]).slice(0,5);
                  if(sItems.length>0) setForm({...form,articles:sItems.map(it=>({ref:it.reference,designation:it.designation,qte:String(it.quantite||"")}))});
                  else toast_("Sélectionnez une base dans le stock d'abord","error");
                }}><Ic n="grid" s={12}/>Importer depuis le stock actuel</Btn>
              </div>
            </Card>
            ...
            <div style={{background:T.greenBg,border:`1px solid ${T.greenBdr}`,borderRadius:12,padding:"16px 20px"}}>
              <div style={{fontSize:11,color:T.green,fontWeight:600,textTransform:"uppercase",letterSpacing:.8,marginBottom:6}}>Aperçu du numéro</div>
              <div style={{fontSize:28,fontWeight:800,color:T.green,letterSpacing:1}}>{form.numeroBT}</div>
              <div style={{fontSize:11,color:T.green,marginTop:4}}>{form.date} · {form.interlocuteur||"—"}</div>
            </div>
        ...
        <div style={{textAlign:"center",marginTop:8}}>
          <Btn onClick={printBT} sx={{padding:"12px 36px",fontSize:15}}>
